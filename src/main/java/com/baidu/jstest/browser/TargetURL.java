...
public class TargetURL {
	...
	public static TargetURL getURL(Browser browser) {
		...
		url.setPort(String.valueOf(Main.getServerPort()));
		url.setPath("capture");
		url.addParam("name", browser.getName());
		url.addParam("id", browser.getId());
		return url;
	}
}
